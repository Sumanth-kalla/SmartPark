        ...
        <div className="min-h-screen bg-[#050b18] text-white flex">
            ...
            <div className="flex flex-col justify-center w-full lg:w-1/2 px-8 md:px-16">
                <div className="w-full max-w-md mx-auto">
                    ...
                    {/* Role Selector */}
                    <div className="mb-8">
                        <p className="text-sm text-gray-400 mb-3">Login as</p>
                        <div className="grid grid-cols-3 gap-2">
                            {["user", "staff", "admin"].map((r) => (
                                <button
                                    key={r}
                                    type="button"
                                    onClick={() => setRole(r as "user" | "staff" | "admin")}
                    ...
                    <button className="w-full bg-white text-black py-3 rounded-lg font-semibold flex items-center justify-center gap-3 hover:bg-gray-200 transition shadow-md">
                        <img
